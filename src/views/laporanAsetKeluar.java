...
import static views.laporanAsetMasuk.maximixed;

public class laporanAsetKeluar extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","Tanggal","ID BK","Lokasi Aset","Kode Aset","Nama Aset","Qty","Keterangan"};
    ...
    public void pencarian(String sql){
        ...
        try{
            ...
            while (hasil.next()){
                ...
                String[] data = {"",tanggal,id_bk,lokasi_aset,kode_aset,nama_aset,jumlah,keterangan};
                tabmode.addRow(data);
                noTable();
            }
        } catch(Exception e){
     ...
     */
    public laporanAsetKeluar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tanggal();
        dataTable();
    ...
    private void initComponents() {
        ...
        labelNama.setText("Laporan Aset Keluar");
    ...
    private void tabelBarangKeluarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelBarangKeluarMouseClicked
        ...
        try{
            ...
            Logger.getLogger(laporanAsetKeluar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from tb_detail_brg_keluar where id_bk like '%"+txtCari.getText()+"%' or nama_aset like '%"+txtCari.getText()+"%'";
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            ...
            laporanAsetKeluar.this.dispose();
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(laporanAsetKeluar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                laporanAsetKeluar dialog = new laporanAsetKeluar(new javax.swing.JFrame(), true);
