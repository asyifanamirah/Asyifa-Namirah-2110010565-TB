 ...
 *
 */
public class dataAset extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","Tanggal","Kode Aset","Nama Aset","Keterangan"};
        tabmode = new DefaultTableModel(null, Baris);
        tabelAset.setModel(tabmode);
        ...
        try{
            ...
            while (hasil.next()){
                ...
                String[] data = {"",tanggal,kode_aset,nama_aset,keterangan};
                tabmode.addRow(data);
                noTable();
            }
        } catch (Exception e){
    ...
    public void lebarKolom(){
        TableColumn column;
        tabelAset.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tabelAset.getColumnModel().getColumn(0);
        column.setPreferredWidth(40);
        column = tabelAset.getColumnModel().getColumn(1);
        column.setPreferredWidth(150);
        column = tabelAset.getColumnModel().getColumn(2);
        column.setPreferredWidth(150);
        column = tabelAset.getColumnModel().getColumn(3);
        column.setPreferredWidth(300);
        column = tabelAset.getColumnModel().getColumn(4);
    ...
    /**
     * Creates new form dataAset
     */
    public dataAset(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        aktif();
        dataTable();
    ...
    private void initComponents() {
        ...
        tabelAset.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        tabelAset.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tabelAset.setRowHeight(30);
        tabelAset.setRowMargin(2);
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from tb_aset where kode_aset like '%"+txtCari.getText()+"%' or nama_aset like '%"+txtCari.getText()+"%'";
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (ok==0){
            String sql="delete from tb_aset where kode_aset='"+txtKodeAset.getText()+"'";
            try {
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "update tb_aset set tanggal=?,kode_aset=?,nama_aset=?,keterangan=? where kode_aset='"+txtKodeAset.getText()+"'";
        ...
        try {
            ...
            stat.setString(2, txtKodeAset.getText());
            stat.setString(3, txtNamaAset.getText());
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        if(txtKodeAset.getText().equals("")){
            ...
            String sql = "insert into tb_aset values (?,?,?,?)";
            String tampilan = "dd-MM-yyyy";
            SimpleDateFormat fm = new SimpleDateFormat(tampilan);
            String tanggal = String.valueOf(fm.format(btnPilihTanggal.getDate()));
            try {
    ...
    private void tabelAsetMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelAsetMouseClicked
        int bar = tabelAset.getSelectedRow();
        ...
        Date dateValue = null;
        try{
            dateValue = date.parse((String)tabelAset.getValueAt(bar, 1));
        } catch (ParseException ex){
            Logger.getLogger(dataAset.class.getName()).log(Level.SEVERE, null, ex);
        }

        btnPilihTanggal.setDate(dateValue);
        txtKodeAset.setText(c);
        txtNamaAset.setText(d);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dataAset dialog = new dataAset(new javax.swing.JFrame(), true);
