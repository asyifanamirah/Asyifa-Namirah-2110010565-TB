...
public class laporanAsetMasuk extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","Tanggal","ID BM","Lokasi Aset","Kode Aset","Nama Aset","Qty","Keterangan"};
    ...
    public void pencarian(String sql){
        ...
        try{
            ...
            while (hasil.next()){
                ...
                String[] data = {"",tanggal,id_bm,lokasi_aset,kode_aset,nama_aset,jumlah,keterangan};
                tabmode.addRow(data);
                noTable();
            }
        } catch(Exception e){
     ...
     */
    public laporanAsetMasuk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tanggal();
        dataTable();
    ...
    private void initComponents() {
        ...
        labelNama.setText("Laporan Aset Masuk");
    ...
    private void tabelBarangMasukMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelBarangMasukMouseClicked
        ...
        try{
            ...
            Logger.getLogger(laporanAsetMasuk.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from tb_detail_brg_masuk where id_bm like '%"+txtCari.getText()+"%' or nama_aset like '%"+txtCari.getText()+"%'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(laporanAsetMasuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                laporanAsetMasuk dialog = new laporanAsetMasuk(new javax.swing.JFrame(), true);
