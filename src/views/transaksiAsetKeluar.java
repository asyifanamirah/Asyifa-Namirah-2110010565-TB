...
import static views.transaksiAsetMasuk.maximixed;

public class transaksiAsetKeluar extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","Tanggal","ID Detail BK","ID BK","Lokasi Aset","Kode Aset","Nama Aset","Qty","Keterangan"};
        ...
        try{
            ...
            while (hasil.next()){
                ...
                String[] data = {"",tanggal,id_detail_bk,id_bk,lokasi_aset,kode_aset,nama_aset,jumlah,keterangan};
                tabmode.addRow(data);
                noTable();
            }
        } catch (Exception e){
     ...
     */
    public transaksiAsetKeluar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        aktif();
        autoIdBK();
    ...
    private void initComponents() {
        ...
        labelNama.setText("Transaksi Aset Keluar");
        ...
        labelKodePart.setText("Kode Aset");
        ...
        labelGudang.setText("Lokasi Aset");
        ...
        labelNamaBarang2.setText("Nama Aset");
    ...
    private void tabelBarangKeluarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelBarangKeluarMouseClicked
        ...
        try{
            ...
            Logger.getLogger(transaksiAsetKeluar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "update tb_detail_brg_keluar set tanggal=?,id_detail_bk=?,id_bk=?,lokasi_aset=?,kode_aset=?,nama_aset=?,jumlah=?,keterangan=? where id_detail_bk='"+txtIdDetailBarangKeluar.getText()+"'";
        String tampilan = "dd-MM-yyyy";
        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
        String tanggal = String.valueOf(fm.format(btnPilihTanggal.getDate()));
        try {
    ...
    private void txtCariBarangKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariBarangKeyTyped
        String sqlPencarian2 = "select * from tb_aset where kode_aset like '%"+txtCariBarang.getText()+"%' or nama_aset like '%"+txtCariBarang.getText()+"%'";
    ...
    private void txtCariGudangKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariGudangKeyTyped
        String sqlPencarian3 = "select * from tb_ruang where kode_ruang like '%"+txtCariGudang.getText()+"%' or nama_ruang like '%"+txtCariGudang.getText()+"%'";
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            ...
            transaksiAsetKeluar.this.dispose();
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(transaksiAsetKeluar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                transaksiAsetKeluar dialog = new transaksiAsetKeluar(new javax.swing.JFrame(), true);
