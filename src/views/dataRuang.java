 ...
 *
 */
public class dataRuang extends javax.swing.JDialog {
    ...
    private void aktif(){
        txtKodeRuang.setEnabled(true);
        txtNamaRuang.setEnabled(true);
        txtKeterangan.setEnabled(true);
    }
    
    protected void kosong(){
        txtKodeRuang.setText(null);
        txtNamaRuang.setText(null);
    ...
    public void dataTable(){
        Object[] Baris = {"No","Tanggal","Kode Ruang","Nama Ruang","Keterangan"};
        tabmode = new DefaultTableModel(null, Baris);
        tabelRuang.setModel(tabmode);
        ...
        try{
            ...
            while (hasil.next()){
                ...
                String[] data = {"",tanggal,kode_ruang,nama_ruang,keterangan};
                tabmode.addRow(data);
                noTable();
            }
        } catch (Exception e){
    ...
    public void lebarKolom(){
        ...
        column = tabelRuang.getColumnModel().getColumn(0);
        column.setPreferredWidth(40);
        column = tabelRuang.getColumnModel().getColumn(1);
        column.setPreferredWidth(150);
        column = tabelRuang.getColumnModel().getColumn(2);
        column.setPreferredWidth(150);
        column = tabelRuang.getColumnModel().getColumn(3);
        column.setPreferredWidth(300);
        column = tabelRuang.getColumnModel().getColumn(4);
     ...
     */
    public dataRuang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        aktif();
        dataTable();
    ...
    private void initComponents() {
        ...
        labelKodeRuang = new javax.swing.JLabel();
        ...
        labelKodeRuang.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        labelKodeRuang.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        labelKodeRuang.setText("Kode Ruang");
        labelKodeRuang.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        labelNamaRuang.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        labelNamaRuang.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        labelNamaRuang.setText("Nama Ruang");
        labelNamaRuang.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        txtKodeRuang.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtKodeRuang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtKodeRuangKeyPressed(evt);
            }
        });
        ...
        txtNamaRuang.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtNamaRuang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtNamaRuangKeyPressed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(labelKodeRuang, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(labelNamaRuang, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(5, 5, 5)
                                        .addComponent(txtKodeRuang, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(5, 5, 5)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGap(5, 5, 5)
                                    .addComponent(labelKodeRuang, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(5, 5, 5)
                                    .addComponent(labelNamaRuang, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void tabelRuangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelRuangMouseClicked
        ...
        Date dateValue = null;
        try{
            dateValue = date.parse((String)tabelRuang.getValueAt(bar, 1));
        } catch (ParseException ex){
            Logger.getLogger(dataRuang.class.getName()).log(Level.SEVERE, null, ex);
        }

        btnPilihTanggal.setDate(dateValue);
        txtKodeRuang.setText(c);
        txtNamaRuang.setText(d);
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        if(txtKodeRuang.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Kode Ruang tidak boleh kosong");
        } else if (txtNamaRuang.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Nama Ruang tidak boleh kosong");
        } else {
        String sql = "insert into tb_ruang values (?,?,?,?)";
        ...
        try {
            ...
            stat.setString(2, txtKodeRuang.getText());
            stat.setString(3, txtNamaRuang.getText());
            stat.setString(4, txtKeterangan.getText());
            stat.executeUpdate();
            JOptionPane.showMessageDialog(null,"Data Berhasil Disimpan");
            //            String refresh = "select * from tb_ruang";
            kosong();
            dataTable();
            lebarKolom();
            txtKodeRuang.requestFocus();
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "update tb_ruang set tanggal=?,kode_ruang=?,nama_ruang=?,keterangan=? where kode_ruang='"+txtKodeRuang.getText()+"'";
        String tampilan = "dd-MM-yyyy";
        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
        String tanggal = String.valueOf(fm.format(btnPilihTanggal.getDate()));
        try {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (ok==0){
            String sql="delete from tb_ruang where kode_ruang='"+txtKodeRuang.getText()+"'";
            try {
                PreparedStatement stat=conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from tb_ruang where kode_ruang like '%"+txtCari.getText()+"%' or nama_ruang like '%"+txtCari.getText()+"%'";
        pencarian(sqlPencarian);
        lebarKolom();
    }//GEN-LAST:event_txtCariKeyTyped

    private void txtKodeRuangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtKodeRuangKeyPressed
        if(evt.getKeyCode()== KeyEvent.VK_ENTER){
            txtNamaRuang.requestFocus();
        }
    }//GEN-LAST:event_txtKodeRuangKeyPressed

    private void txtNamaRuangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNamaRuangKeyPressed

    }//GEN-LAST:event_txtNamaRuangKeyPressed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dataRuang dialog = new dataRuang(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JLabel labelKodeRuang;
